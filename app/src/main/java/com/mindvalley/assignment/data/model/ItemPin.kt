package com.mindvalley.assignment.data.model

import android.util.Log
import com.google.gson.JsonObject
import java.io.Serializable

data class ItemPin(var id: String = "",
    ...
    companion object {
        fun fromJsonObject(obj: JsonObject): ItemPin {
            val pin = ItemPin()
            try {
                ...
                //If image_holder return a default pin
